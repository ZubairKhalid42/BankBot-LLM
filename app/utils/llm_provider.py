...
class LLMProvider:
    ...
    def create_rag_chain(self) -> Runnable:
        ...
        prompt_template = """
        You are an AI assistant for Bank Bot, a trusted financial institution. Your role is to provide helpful, accurate, and professional responses to customer inquiries about the bank's products, services, and procedures.
    ...
    def handle_out_of_domain_query(self, query: str) -> str:
        ...
        """
        return (
            "I'm a Bank Bot assistant, designed to help with banking-related inquiries. "
            "It seems your question is not related to Bank Bot services. "
